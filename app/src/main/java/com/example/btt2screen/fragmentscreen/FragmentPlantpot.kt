...
class FragmentPlantpot : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_plantpot, container, false)
    }
    companion object {
        fun newInstance(): FragmentPlantpot = FragmentPlantpot()
    }
    ...
    fun getplantpotData(){
        Api.retrofitService. getplantpotData().enqueue(object: Callback<List<Property>> {
